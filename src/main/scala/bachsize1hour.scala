...
object bachsize1hour {
  def main(args: Array[String]): Unit = {
    ...
    val inputFilePath = "csvInter/interpolated_signals_no_outliers/part-00000-97956986-bdf7-4f6b-bf24-938de44de996-c000.csv"
    val outputFilePath = "csvOutPut1day"
    ...
    val batchSize = 360 // Définir le lot à 3600 lignes
    ...
    // Traiter les données par lots de 3600 lignes et écrire dans un fichier CSV
    for (i <- 0 until numBatches) {
      ...
      val singlePartitionDF = batchDF.coalesce(1)
